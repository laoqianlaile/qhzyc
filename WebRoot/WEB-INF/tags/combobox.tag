<%@ attribute name="id" %><%@ attribute name="onClick" %><%@ attribute name="showOnFocus" type="java.lang.Boolean"%><%@ attribute name="style" %><%@ attribute name="buttons" %><%@ attribute name="labelField" %><%@ attribute name="iframePanel" type="java.lang.Boolean" %><%@ attribute name="starBefore" type="java.lang.Boolean" %><%@ attribute name="enableSearch" type="java.lang.Boolean" %><%@ attribute name="enablePinyin" type="java.lang.Boolean" %><%@ attribute name="enableHighlight" type="java.lang.Boolean" %><%@ attribute name="placeholder" %><%@ attribute name="name" %><%@ attribute name="cls" %><%@ attribute name="componentCls" %><%@ attribute name="forceSelection" type="java.lang.Boolean" %><%@ attribute name="rendered" type="java.lang.Boolean" %><%@ attribute name="authorized" %><%@ attribute name="readonlyInput" type="java.lang.Boolean" %><%@ attribute name="formatter" %><%@ attribute name="onShowPanel" %><%@ attribute name="onHidePanel" %><%@ attribute name="panelRenderOnShow" type="java.lang.Boolean" %><%@ attribute name="readonly" type="java.lang.Boolean" %><%@ attribute name="required" type="java.lang.Boolean" %><%@ attribute name="showStar" type="java.lang.Boolean"%><%@ attribute name="showRequiredMark"%><%@ attribute name="hideRequiredMark"%><%@ attribute name="errMsg" %><%@ attribute name="errMsgPosition" %><%@ attribute name="valueField" %><%@ attribute name="textField" %><%@ attribute name="width" type="java.lang.Integer" %><%@ attribute name="height" type="java.lang.Integer" %><%@ attribute name="panelWidth" type="java.lang.Integer" %><%@ attribute name="maxPanelHeight" type="java.lang.String" %><%@ attribute name="panelHeight" type="java.lang.String" %><%@ attribute name="multiple" type="java.lang.Boolean" %><%@ attribute name="separator" %><%@ attribute name="editable" type="java.lang.Boolean" %><%@ attribute name="isLabel" type="java.lang.Boolean" %><%@ attribute name="disabled" type="java.lang.Boolean" %><%@ attribute name="hasDownArrow" type="java.lang.Boolean" %><%@ attribute name="value" %><%@ attribute name="emptyText" %><%@ attribute name="showClose" type="java.lang.Boolean" %><%@ attribute name="showDirection"%><%@ attribute name="enableFilter" type="java.lang.Boolean" %><%@ attribute name="delay" type="java.lang.Integer" %><%@ attribute name="url" %><%@ attribute name="method" %><%@ attribute name="postMode" %><%@ attribute name="data" %><%@ attribute name="onValidError" %><%@ attribute name="onValidSuccess" %><%@ attribute name="onCreate" type="java.lang.String" %><%@ attribute name="onChange" type="java.lang.String" %><%@ attribute name="onLoad" type="java.lang.String" %><%@ attribute name="beforeSelect" %><%@ attribute name="onKeyUp" %><%@ attribute name="onKeyDown" %><%@ attribute name="onUnSelect" %><%@ attribute name="onSelect" type="java.lang.String" %><%@ attribute name="triggers"%><%@ attribute name="excluded" type="java.lang.Boolean"%><%@ attribute name="onBlur" type="java.lang.Boolean"%><%@ include file="TagUtil.jsp" %><% 
