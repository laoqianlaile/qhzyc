package com.ces.component.ttscjcxx.service;
...
@Component
public class TtscjcxxService extends TraceShowModuleDefineDaoService<StringIDEntity, TtscjcxxDao> {
...
//				String jcId = save("T_TT_SCJCXX", dataMap, null);
//
//				//更新种植出场（已进场）
...
//			}
            ...
            if (dataMap != null && !dataMap.isEmpty()) {
                ...
                for (Map<String, Object> sh : shList) {
                    ...
                    saveMap.put("TTXFDWBM", SerialNumberUtil.getInstance().getCompanyCode());
                    saveMap.put("TTXFDWMC", CompanyInfoUtil.getInstance().getCompanyName("TT", SerialNumberUtil.getInstance().getCompanyCode()));
                    ...
                    String jcId = save("T_TT_SCJCXX", saveMap, null);
                    ids.add(jcId);
                }
