...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/cjgylllxxxz";
};
...
//			colNames:["部门编号","部门名称"],
//			url:"sdzyccjgylllxx!searchLlbmxx.json",
//			panelWidth:"290",
//			textField:"BMMC",
//			//valueField:"BMBH",
//			valueField:"BMMC",
...
//		})
		...
		//将物料规格改为下拉列表
		ui.getItemJQ("WLGG").textbox("destroy");
		ui.getItemJQ("WLGG").combogrid({
	...
	ui.bindEvent = function(){
        ...
        pch.combogrid("option","onChange",function(e,data) {
			...
			ui.setFormData({PCH:rowData.PCH,LLMC:rowData.YLMC,FLCK:rowData.SLCK,YCDM:rowData.YCDM,LLZZL:rowData.YLKC,QYPCH:rowData.QYPCH});
		});

        //验证领料重量小于库存重量
        ui.setItemOption("LLZZL","onChange",function(e,data){
            var jyzl = ui.getItemValue("LLZZL");
            var rkzl = rowData.YLKC;
            if(jyzl>rkzl){
	...
	ui.addCallback("setComboGridValue_pch",function(o){
		...
		var obj = o.rowData;
		if(null == obj) return;
		ui.setFormData({PCH:obj.PCH,LLMC:obj.YLMC,LLZZL:obj.RKZL});
	});
//发料仓库的回调函数
