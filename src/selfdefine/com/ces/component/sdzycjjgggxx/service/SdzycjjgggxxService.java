package com.ces.component.sdzycjjgggxx.service;
...
@Component
public class SdzycjjgggxxService extends TraceShowModuleDefineDaoService<StringIDEntity, SdzycjjgggxxDao> {
    ...
    public Object getGzryda() {
        ...
        String sql="select t.GGBH,t.GG from T_SDZYC_JJG_GGXX t where t.qybm = ? and t.is_delete = '0'";
