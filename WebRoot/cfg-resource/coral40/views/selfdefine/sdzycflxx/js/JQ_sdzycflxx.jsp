...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycflxx";
};
...
function _override_form (ui) {
	...
	ui._init = function(){
		...
		if (isEmpty(ui.options.dataId)){
			var lxData = $.loadJson($.contextPath+"/sdzycflxx!getLx.json");
		...
		if (!isEmpty(ui.options.dataId)){
			...
			ui.getItemJQ("LX").combobox("reload",lxData);
			var lxData = $.loadJson($.contextPath+"/sdzycflxx!getLxById.json?id="+ui.options.dataId);
