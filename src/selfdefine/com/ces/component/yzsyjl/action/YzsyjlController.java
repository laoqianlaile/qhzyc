package com.ces.component.yzsyjl.action;
...
import com.ces.component.yzsyjl.service.YzsyjlService;
...
public class YzsyjlController extends TraceShowModuleDefineServiceDaoController<StringIDEntity, YzsyjlService, TraceShowModuleDao> {

    private static final long serialVersionUID = 1L;
    private static Log log = LogFactory.getLog(YzsyjlController.class);
    /*
     * (非 Javadoc)   
     * <p>标题: initModel</p>   
     * <p>描述: </p>      
