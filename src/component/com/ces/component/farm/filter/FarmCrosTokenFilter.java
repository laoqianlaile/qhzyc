package com.ces.component.farm.filter;
...
public class FarmCrosTokenFilter  extends GenericFilterBean{
	
	private final static String FARM_TOKEN_PARAM = "Farm-Token";
...
//		if (tokens.length != 3) {
//			httpResponse.sendError(HttpServletResponse.SC_FORBIDDEN, ResponseUtil.TOKEN_ERROR);
//			return false;
//		}
