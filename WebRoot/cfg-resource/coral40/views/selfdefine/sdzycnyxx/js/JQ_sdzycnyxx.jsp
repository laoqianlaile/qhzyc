...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycnyxx";
};
...
function _override_form (ui) {
	...
	ui._init = function(){
		...
		if (isEmpty(ui.options.dataId)){
			var lxData = $.loadJson($.contextPath+"/sdzycnyxx!getLx.json");
		...
		if (!isEmpty(ui.options.dataId)){
			...
			ui.getItemJQ("LX").combobox("reload",lxData);
			var lxData = $.loadJson($.contextPath+"/sdzycnyxx!getLxById.json?id="+ui.options.dataId);
