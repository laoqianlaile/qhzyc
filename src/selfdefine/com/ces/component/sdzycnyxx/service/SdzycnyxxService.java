package com.ces.component.sdzycnyxx.service;
...
@Component
public class SdzycnyxxService extends TraceShowModuleDefineDaoService<StringIDEntity, SdzycnyxxDao> {
    ...
    public Map<String, String> save(String tableId, String entityJson, Map<String, Object> paramMap) {
        ...
        if(StringUtil.isEmpty(id)){//是新增操作
            String nybh = SerialNumberUtil.getInstance().getSerialNumber("SDZYC", "SDZYCNYBH", false);
            dataMap.put("NYBH",nybh);
        }
    ...
    public Object getLxById(String id) {
        ...
        String sql = "select lx from t_sdzyc_nyxx  where  qybm=? and id=?";
     ...
     */
    public Object getLx() {
        String sql = "select distinct sjbm as value, sjmc as text from t_common_sjlx_code  where sjbm = 'NY'";
