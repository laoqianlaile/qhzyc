package com.ces.component.tcssczzqyxx.service;
...
@Component
public class TcssczzqyxxService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {

    public Object getQyxxGridData(){
	    String sql = "select t.QYBH,t.QYMC,t.QYMJ,t.FZR from T_ZZ_QYXX t where t.QYBM = ? and t.IS_DELETE <>1" ;
