...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/i-ckxx";
};
...
function _override_form (ui) {
	...
	//};
	ui.bindEvent =function () {
		var khmc = ui.getItemJQ("KHMC");
		khmc.combogrid("option", "onChange", function (e, data) {
			var rowData = khmc.combogrid("grid").grid("getRowData", data.value);
			ui.setFormData({KHMC: rowData.SHMC, KHDM: rowData.SHBM})
