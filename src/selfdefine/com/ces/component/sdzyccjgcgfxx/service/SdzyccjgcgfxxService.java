package com.ces.component.sdzyccjgcgfxx.service;
...
@Component
public class SdzyccjgcgfxxService extends TraceShowModuleDefineDaoService<StringIDEntity, SdzyccjgcgfxxDao> {
    public Map<String, String> save(String tableId, String entityJson, Map<String, Object> paramMap) {
        ...
        if (StringUtil.isEmpty(id)) {//是新增操作
            String flbh = SerialNumberUtil.getInstance().getSerialNumber("SDZYC", "SDZYCCJGCGFXX", false);
    ...
    public Object getGzryda() {
        ...
        String sql="select t.CGSBH,t.CGSMC from T_SDZYC_CJG_CGFXX t where t.qybm = ? and t.is_delete = '0'";
