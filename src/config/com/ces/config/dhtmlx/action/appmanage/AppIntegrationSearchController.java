...
import com.ces.config.dhtmlx.service.appmanage.AppIntegrationSearchService;
import com.ces.xarch.core.exception.FatalException;

public class AppIntegrationSearchController extends ConfigDefineServiceDaoController<AppIntegrationSearch, AppIntegrationSearchService, AppIntegrationSearchDao> {

	private static final long serialVersionUID = 1L;
	
	private static final Log log = LogFactory.getLog(AppIntegrationSearchController.class);
	
	@Override
    protected void initModel() {
        setModel(new AppIntegrationSearch());
    }
    ...
    @Override
    @Autowired
    @Qualifier("appIntegrationSearchService")
    protected void setService(AppIntegrationSearchService service) {
