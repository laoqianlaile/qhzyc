...
$.component("coral.inputbase", $.coral.formelement, {
	...
	_outerButtons: function() {
		...
		this._createtoolPanelItems(this.options.buttonOptions,null, this.uiDialogOuterButtonPanel, "button");
	...
	_createButtonPanel: function() {
		...
		// 兼容buttons的旧的构造方法
		if (!is) {
			this.uiDialogButtonPanel = $("<span class='" + key + " coral-textbox-btn-icons coral-buttonset coral-corner-" 
				+ direction+" '></span>"); 
