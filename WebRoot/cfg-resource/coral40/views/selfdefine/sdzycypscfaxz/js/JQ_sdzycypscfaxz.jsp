...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycypscfaxz";
};
...
function _override_form (ui) {
	...
	ui.bindEvent = function (){
		ui.setItemOption("YCL", "onChange", function(e,data){
			var rowData = ui.getItemJQ("YCL").combogrid("grid").grid("getRowData",data.value);
			ui.setFormData({
				YCL:rowData.YCMNAME,
                YCDM:rowData.ZSSPM
			});
