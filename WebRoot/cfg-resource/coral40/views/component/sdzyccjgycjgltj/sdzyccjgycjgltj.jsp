...
<div class="toolbarsnav clearfix">
    <div class="coral-toolbar-item-component coral-toolbar-html ctrl-toolbar-element" group="upper left" data-frozen="true" style="right: auto; left: 0px;">
        <h1>
                <span class="homeSpan" style="padding-left: 30px;"> - 药材加工量统计
                </span>
        </h1>
    </div>
</div>
    ...
    <ces:form id="form${idSuffix}" name="form">
        <div class="fillwidth colspan3 clearfix ">
            ...
            <div class="app-inputdiv8">
                <label class="app-input-label">加工日期：</label>
    ...
    $.extend($.ns("namespaceId${idSuffix}"), {
        toolbarClick : function ( e , ui ){
            ...
            if( ui.id == 'search' ){
                ...
                var jsonData = $.loadJson($.contextPath + "/sdzyccjgycjgltj!searchj.json?kssj="+$formData.KSSJ+"&jssj="+$formData.JSSJ+"&rqlx="+$formData.RQLX+"&cpmc="+$formData.CPMC);
                if(jsonData.series.length == 0){
                    CFG_message("查询区间内无加工数据", "error");
                }
                initCharts(jsonData);
            }
        }
