...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycypscxx";
};
...
function _override_form (ui) {
    ...
    ui._init = function(){
        hUI= ui;
        //初始化图片删除区域
        var tpscDiv = ui.getItemBorderJQ("xctp");
        tpscDiv.empty();
    ...
    ui.bindEvent = function(){
        ...
        scfabh.combogrid("option","onChange",function(e,data) {
            ...
            ui.setFormData({SCFABH:data.text,YPMC:rowData.YPMC,JGGY:rowData.JGGY,YCDM:rowData.YCDM});
        });
        /*领料单号下拉数据*/
        ...
        ui.setItemOption("QYPCH","onChange" , function( e ,data){
            ...
            ui.setFormData({YYCPCH:rowData.PCH,JGZZL:rowData.LLZZL,YCDM:rowData.YCDM,CSPCH:rowData.CSPCH,QYPCH:rowData.QYPCH});
        })
    };
...
//            div.style.marginTop = "10px";
    ...
    deleteImage : function (src) {
        ...
        $.ajax({
            type: "POST",
            url: $.contextPath + '/sdzycypscxx!deleteTp.json',
