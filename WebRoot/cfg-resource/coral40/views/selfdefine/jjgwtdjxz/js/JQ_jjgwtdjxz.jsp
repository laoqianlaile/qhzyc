...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/jjgwtdjxz";
};
...
function _override_form (ui) {
	...
	ui._init = function() {
		...
		ui.getItemJQ("QYPCH").combogrid("reload",$.contextPath+"/sdzycjjgypjyjcxx!getycjy.json");
	}
...
//            div.style.marginTop = "10px";
		...
		deleteImage : function (src) {
			...
			$.ajax({
				type: "POST",
				url: $.contextPath + '/jjgqyzjxz!deleteTp.json',
