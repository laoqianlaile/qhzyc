package com.ces.component.sdszyyypjc.action;

import com.ces.component.sdszyyypjc.dao.SdszyyypjcDao;
import com.ces.component.sdszyyypjc.service.SdszyyypjcService;
...
public class SdszyyypjcController extends TraceShowModuleDefineServiceDaoController<StringIDEntity, SdszyyypjcService, SdszyyypjcDao> {

    private static final long serialVersionUID = 1L;
    private static Log log = LogFactory.getLog(SdszyyypjcController.class);
    /*
     * (非 Javadoc)
     * <p>标题: initModel</p>
     * <p>描述: </p>
