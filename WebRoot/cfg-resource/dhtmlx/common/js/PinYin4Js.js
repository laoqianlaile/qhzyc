PinYin4Js = function() {
	return {
		...
		isEnKong1 : function(argValue) {// 是否是英文或数字
			var flag = false;
		...
		toPinyin : function(l1) {// 将汉字转换成拼音，若为英文或数字则不转换
			if (l1) {
				var l2 = l1.length;
				var I1 = "";
		...
		getFirstChar : function(str) {// 取汉字首字母
			if (str) {
				var ret = "";
				for (var i = 0; i < str.length; i++) {
					if (this.isEnKong1(str.charAt(i))) {
						ret += str.charAt(i);
					} else {
						ret += this.toPinyin(str.charAt(i)).charAt(0);
					}
				}
