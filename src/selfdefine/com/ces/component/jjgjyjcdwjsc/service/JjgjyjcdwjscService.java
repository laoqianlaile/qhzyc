package com.ces.component.jjgjyjcdwjsc.service;
...
@Component
public class JjgjyjcdwjscService extends TraceShowModuleDefineDaoService<StringIDEntity, JjgjyjcdwjscDao> {
    ...
    public Object saveAll(String tableId, String entityJson, String dTableId, String dEntitiesJson, Map<String, Object> paramMap) {//
        ...
        String sql = "select t.id,t.scpch from t_sdzyc_jjg_ypscxx t where t.scpch=?";
        ...
        if(inserted){//新增进行数据同步操作
           ...
           // detailList   = saveDetail(dTableName, dEntitiesJson, dataMap, relateDateMap, paramMap);
            detailList   = saveDetail(dTableName, dEntitiesJson, dataMap, relateDateMap, paramMap,predataList,process_id);
            sendModifyTestEntity(id,dataMap,predataList,process_id);
        }
        // 保存明细后业务逻辑处理
    ...
    public void sendModifyTestEntity(String id,Map<String, String> map,List<TestFileEntity>predataList,String process_id){
        EnterpriseService service = new RearClientBuilder().build(EnterpriseService.class);
        TestEntity testEntity = testService(map,predataList,process_id);
    ...
    private TestEntity testService(Map<String, String> map,List<TestFileEntity>predataList,String process_id)
    {
        ...
        String sql = "select JGGY from t_sdzyc_jjg_ypscxx t where t.scpch=? and qybm=?";
