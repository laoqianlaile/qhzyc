...
<script type="text/javascript">
    ...
    (function (subffix) {
        ...
        window[CFG_actionName(subffix)] = function (ui) {
            ...
            return jQuery.contextPath + "/sdzycyljyjcxx";
        };
        ...
        function _override_form(ui) {
            ui._init = function () {
                ...
                if (isEmpty(ui.options.dataId)) {
                    ...
                    $.ns("ns" + subffix + "").uploadImage($.contextPath + "/spzstpfj/" + formData.JYWJ,ui.options.isView);
                    ui.getItemJQ("QYPCH").combogrid("destroy");
                    ui.getItemJQ("QYPCH").textbox();
                    ui.getItemJQ("QYPCH").textbox("setValue",formData.QYPCH);
            ...
            ui.bindEvent = function () {
                ...
                ui.getItemJQ("JYSJ").datepicker("option", "onChange", function (e, data) {
                    ui.getItemJQ("JYSJ").datepicker("option", "minDate", data.value);
                });
            }
            ...
            ui.addCallback("setComboGridValue_yljyjc", function (o) {
                if (null == o) return;
        ...
        function _override_bsearch(ui) {
            ...
            ui.addCallback("setComboGridValue_yljyjc", function (o) {
                ...
                var rowData = o.rowData;
                if (null == rowData) return;
                ui.setItemValue("ZZPCH",rowData.ZZPCH);
...
//            div.style.marginTop = "10px";
            ...
            deleteImage: function (src) {
                $.ajax({
                    type: "POST",
                    url: $.contextPath + '/sdzycyljyjcxx!deleteTp.json',
                    data: {'id': hUI.options.dataId},
                    dataType: "json",
                    success: function (data) {
                        var view = $("#view${idSuffix}");
                        hUI.setFormData({"JYWJ": ""});
                        view.empty();
                        $("#imageUpload${idSuffix}").val("");
