...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzyczzzzcg";
};
...
//		var qybm = $.loadJson($.contextPath + "/trace!getQybm.json");
		...
		ui.getItemJQ("SCRQ").datepicker("option","onChange", function ( e,data){
			ui.getItemJQ("DQRQ").datepicker("option","minDate",data.value);
			ui.getItemJQ("CGRQ").datepicker("option","minDate",data.value);
		});
		//ui.getItemJQ("ZZMC").combogrid("reload", $.contextPath)
	}
};
