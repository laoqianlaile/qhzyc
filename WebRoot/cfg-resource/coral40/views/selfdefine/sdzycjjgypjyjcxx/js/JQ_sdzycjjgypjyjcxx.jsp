...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycjjgypjyjcxx";
};
...
function _override_grid (ui) {
	...
	ui.clickDelete = function (isLogicalDelete) {
		...
		for(var i in idArr) {
			...
			var url = $.contextPath + "/sdzycypbzxx!queryScPch.json?pch="+rowData.PCH;
...
//            div.style.marginTop = "10px";
		...
		deleteImage : function (src) {
			...
			$.ajax({
				type: "POST",
				url: $.contextPath + '/sdzycjjgypjyjcxx!deleteTp.json',
