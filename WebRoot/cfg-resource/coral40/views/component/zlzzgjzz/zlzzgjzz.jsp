...
<body>
<div id="max${idSuffix}"  style="overflow: hidden;height:550px ">
    ...
    $.getScript("http://api.map.baidu.com/getscript?v=2.0&ak=5bf855579378e7f83002e94a5b62c806&services=&t=20150901171226"
            ,function aa () {
              function createmap(){
                ...
                //定义坐标(第一个客户企业为准)
                var point = new BMap.Point(datamap[0].JD,datamap[0].WD);
                //设置地图初始界面中心点
                map.centerAndZoom(point,10);
				//var marker =new BMap.Marker(point,0);
              ...
              function addMarker(point, index,map,data){
                ...
                //设置标记弹出信息
                  ...
                  img.src = "${basePath}"+"spzstpfj/"+data.LOGOTP;
  ...
  $(function () {
    var configInfo = CFG_initConfigInfo({
      ...
      'bodyOnLoad': function (configInfo) {
        ...
        var lbConstructDetails = CFG_getReserveZoneInfo(configInfo, "gjzzlb", '2');
