package com.ces.component.csglbatj.service;
...
@Component
public class CsglbatjService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {
    ...
    public String defaultCode(){
        ...
        return AppDefineUtil.RELATION_AND+" cdbm like '"+csxx+"%' ";
    }
