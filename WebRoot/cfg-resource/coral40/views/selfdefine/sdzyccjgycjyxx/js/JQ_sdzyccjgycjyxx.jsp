...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzyccjgycjyxx";
};
...
function _override_form (ui) {
	...
	ui.bindEvent = function(){
		...
		pch.combogrid("option","onChange",function(e,data) {
			...
			ui.setFormData({PCH:rowData.JGPCH,YCMC:rowData.YCMC,CDMC:rowData.YLCD,JYZL:rowData.RKZL,QYPCH:rowData.QYPCH});
		});
	}
...
function _override_grid (ui) {
	...
	ui.clickDelete = function (isLogicalDelete) {
		...
		for(var i=0;i<ids.length;i++){
			if(ui.uiGrid.grid('getRowData',ids[i]).SFRK=='0'){
