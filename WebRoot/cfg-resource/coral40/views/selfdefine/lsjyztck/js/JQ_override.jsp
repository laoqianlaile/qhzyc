...
function _override_grid (ui) {
	...
	ui.eSelectRow = function(e,u){
		...
		ui.assembleData.CFG_outputParams.jyzInfo = rowData;
...
//		var pfsbm = ui.getItemJQ("JYZBM");
//		var baltjdbm = pfsbm.textbox("getValue");
//		//var lssbm = ui.getItemJQ("LSSBM").textbox("getValue");
//		var pColumns = "(EQ_C_JYLX≡5) OR (EQ_C_JYLX≡6) OR (EQ_C_JYLX≡7) AND (EQ_C_BALTJDBM≡"+baltjdbm+") AND (EQ_C_ZT≡1)" ;
//		//if(!isEmpty(lssbm)){
//		//pColumns += "AND(NOT_C_JYZBM≡"+lssbm+")"
//		//}
//		var o = {
//			status : true,
//			P_columns : pColumns
