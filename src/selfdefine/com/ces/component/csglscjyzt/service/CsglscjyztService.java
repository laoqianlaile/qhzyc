package com.ces.component.csglscjyzt.service;
...
@Component
public class CsglscjyztService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {
    ...
    public String defaultCode(){
        ...
        if(null!=csxx && !csxx.equals("")  && !csxx.equals("null")){
            ...
            return AppDefineUtil.RELATION_AND+" cdbm='"+csxx+"' ";
        }
