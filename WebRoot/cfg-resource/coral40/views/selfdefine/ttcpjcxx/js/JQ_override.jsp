...
function _override_grid (ui) {
    ...
    function showDiv(ids) {
        ...
        showDiv.dialog({
            ...
            onOpen : function() {
                ...
                var jqShowGrid = $("<div  class=\"coral-adjusted\" style=\"height:350px\"></div>").appendTo(showDiv);
                //加载表单数据
	...
	function setFormData(barCode){
		...
		var ids="";
		if(sysName.toUpperCase() === "JG"){
			ids = $.loadJson($.contextPath + "/ttcpjcxx!barCodeSave.json?barCode=" + barCode);
		}
		if (ids.length == 0) {
			CFG_message("请输入有效的条形码!", "warning");
			return;
