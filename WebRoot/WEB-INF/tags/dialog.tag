...
%><div id="<%=id %>" <%=(style == null ? "style='display:none;'" : "style='display:none;" + style+"'") %> class="<%=cls==null?"":cls%>" data-options="<%=dataOption %>" ><jsp:doBody /></div>
<script <%= "id=" + id + "_s" %>>
Coral.cc("dialog", "<%= id%>");
</script>