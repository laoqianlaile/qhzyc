...
<div id="max${idSuffix}" class="fill">
    <div class="fill">
        <div class="toolbarsnav clearfix">
            ...
            <div class='homeSpan' style="margin-top: -23px;"><div><div style='margin-left:20px;width: 150px;' id="nva${idSuffix}"> - 包装管理 - 详情 </div></div></div>
        </div>
        <form id="bzForm${idSuffix}" action="${basePath}"
            ...
            <div class="fillwidth colspan3 clearfix">
                ...
                <div class="app-inputdiv4">
                    ...
                    <input id="cpgg${idSuffix}" data-options="readonly:true" name="BZGG" class="coralui-textbox"/>
                </div>
                <%--<div class="app-inputdiv4" style="height:32px;display: none">--%>
        ...
        <ces:grid id="gridId${idSuffix}" shrinkToFit="true" forceFit="true" fitStyle="fill" datatype="local"
            ...
            <ces:gridCols>
              ...
              <!--  <ces:gridCol name="CSPCH" editable="false"  width="100">CSPCH</ces:gridCol>-->
                <ces:gridCol name="BZPCZSM" editable="false" formatoptions="required: true"
                ...
                <ces:gridCol name="DKBH" editable="false" width="100">地块编号</ces:gridCol>
                ...
                <ces:gridCol name="KCZL" editable="true" formatter="text" formatoptions="validType:'float',readonly:true"
                             width="100">库存重量</ces:gridCol>
                <ces:gridCol name="JGQZL" editable="true" formatter="text" formatoptions="validType:'float',readonly:true"
                             width="100">加工前重量</ces:gridCol>
                <ces:gridCol name="JGHZL" editable="true" formatter="text" formatoptions="validType:'float',readonly:true"
                ...
                <ces:gridCol name="SHZL" editable="true" formatter="text" formatoptions="validType:'float',readonly:true"
...
<script >
 function sel (cellvalue, options, rawObject){
   return '<a href="#" onclick="$.ns(\'namespaceId${idSuffix}\').cpmcClick();return false;">件数</a>';
   }
</script>
