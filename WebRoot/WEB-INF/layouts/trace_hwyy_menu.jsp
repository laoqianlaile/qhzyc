...
<head>
    ...
    <link href="<%=contextPath %>/cfg-resource/coral40/common/themes/zz1/css/main.css" rel="stylesheet"/>
    <link href="<%=contextPath %>/cfg-resource/coral40/common/themes/hwyy/css/style.css" rel="stylesheet"/>
    <link href="<%=contextPath %>/cfg-resource/coral40/common/themes/hwyy/css/reset.css" rel="stylesheet"/>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(contextPath + "/menu/menu!loadAppMenuForCoral40.json?systemId=" + systemId + "&P_timestamp=" + getTimestamp(), function (data) {
            ...
            $('.logo').append('<img src="<%=contextPath %>/cfg-resource/coral40/common/themes/hwyy/css/images/yllogon.png">');
            menuClick('工作台','/cfg-resource/coral40/views/component/sdzychwyytz/sdzychwyytz.jsp');
                ...
                if(menuA.items.length==0){//菜单下面没有子菜单的走这里
                    if(menuA.code == 'sy'){//加载首页菜单样式
                        var sy ='<span class="menuList">'+
                                '<span class="menuList"><a href="#" class="iconIndex" onclick="menuClick(\'工作台\',\'/cfg-resource/coral40/views/component/sdzychwyytz/sdzychwyytz.jsp\')"></a> </span></span>';
