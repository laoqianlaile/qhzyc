...
$.component( "coral.progressbar", {
	...
	_create: function() {
		...
		this.element
			.addClass( "coral-progressbar coral-component coral-component-content coral-corner-all" );

		this.valueDiv = $( "<div class=\"coral-progressbar-value coral-component-header coral-corner-left\"></div>" )
