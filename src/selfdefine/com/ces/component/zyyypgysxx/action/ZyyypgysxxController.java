package com.ces.component.zyyypgysxx.action;

import com.ces.component.zyyypgysxx.dao.ZyyypgysxxDao;
import com.ces.component.zyyypgysxx.service.ZyyypgysxxService;
...
public class ZyyypgysxxController extends TraceShowModuleDefineServiceDaoController<StringIDEntity, ZyyypgysxxService, ZyyypgysxxDao> {
    ...
    public void searchgysxx(){
        String gysbh= getParameter("gysbh");
        setReturnData(getService().searchypgysxxBygysbh(gysbh));
    }
    /*
     * (非 Javadoc)
     * <p>标题: initModel</p>
