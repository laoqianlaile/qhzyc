...
"use strict";	
	...
	$.fn.afterFmatter =function( colModel ) {
		...
		$(".parseformatter", that.element).each(function(){
			...
			if ( dataFormatter == "combobox" || dataFormatter == "combotree" ){
				$(this)[dataFormatter]( "setValues", value.split(",") );
			}
			if ( dataFormatter == "textbox" ){
				$(this)[dataFormatter]( "setValue", value);
			}
			if ( dataFormatter == "toolbar" ){
				
			}
			if ( dataFormatter == "checkbox" ){
				var cbv = ["Yes","No"];
	...
	$.unformat = function (cellval,options,pos,cnt,state) {
		...
		var ret, state = state || "formatter", formatType = options.colModel[state],
		...
		if ( options.colModel.edittype == "combobox" && options.colModel.revertCode
			...
			if ( formatType == "combobox" || formatType == "combotree" ){
