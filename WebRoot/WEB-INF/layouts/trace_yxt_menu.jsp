...
<div class="ycb">
    ...
    <div class="ycb_header">
        <!--logo-->
        <div class="ycb_login" style="padding-left: 60px">
            <svg class="icon" aria-hidden="true" style="font-size: 60px;position: absolute;left: 0">
                <use xlink:href="#icon-weibiaoti-11"></use>
            </svg>
            <h4>源鑫堂中药材种植加工流通追溯系统</h4>
        </div>
        <!--nav-->
        <div class="ycb_nav">
    ...
    <div id="mainContent" class="sdyc_content" style="z-index:-9999">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="<%=contextPath %>/cfg-resource/coral40/common/themes/qhzyc/images/zy4.png" alt=""></div>
                <div class="swiper-slide"><img src="<%=contextPath %>/cfg-resource/coral40/common/themes/qhzyc/images/zy4.png" alt=""></div>
                <div class="swiper-slide"><img src="<%=contextPath %>/cfg-resource/coral40/common/themes/qhzyc/images/zy4.png" alt=""></div>
            </div>
            <!-- 如果需要分页器 -->
            ...
            $.each(data, function (i, menuA) {
                ...
                if(menuA.items.length==0){//菜单下面没有子菜单的走这里
                    if(menuA.code == 'sy'){//加载首页菜单样式
                        onesy += '<li><a href="javascript:void(0)" onclick="menuClick(\'工作台\',\'/layouts/trace_dlh_menu.jsp\',this)"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-weibiaoti-9"></use>	</svg>'
                            +menuA.name
