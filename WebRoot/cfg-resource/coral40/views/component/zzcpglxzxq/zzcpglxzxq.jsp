    ...
    <div class="fill">
        ...
        <form id="cpForm${idSuffix}" action="${basePath}" style="height:270px"
            ...
            <div class="fillwidth colspan3 clearfix">
                ...
                <!------------------ 第二排开始---------------->
                <div class="app-inputdiv4">
                    <label class="app-input-label">规格(kg)：</label>
                    <input id="gg${idSuffix}" data-options="validType: 'float'" name="GG" class="coralui-textbox"/>
                </div>
                <div class="app-inputdiv4">
                ...
                <div class="app-inputdiv4">
                    <label class="app-input-label">保鲜期(天)：</label>
        ...
        <ces:grid id="gridId${idSuffix}" fitStyle="fill" height="500px" rownumbers="true">
            <ces:gridCols>
                ...
                <ces:gridCol name="DPZBH" formatter="combobox" formatoptions="required: true,readonly:true"
                             width="80">品种</ces:gridCol>
                <ces:gridCol name="XPZBH" formatter="combobox" formatoptions="required: 'true',readonly:true"
        ...
        var configInfo = CFG_initConfigInfo({
            ...
            'bodyOnLoad': function (configInfo) {
                ...
                if (rowDataId !== "" && rowDataId !== null) {
                    $("#cpForm${idSuffix}").form("setReadOnly",true);
                    $("#nva${idSuffix}").html("-产品管理-详情");
