( function() {
	...
	// Load the modules
	var modules = [
		"jquery-1.11.3", "locale-cn", "core", "component", "formelement", "inputbase", "parser",
		"validate", "mouse", "sortable", "draggable", "droppable", "resizable", "selectable", "position",
		"easing", "grid", "grid.common", "grid.celledit", "grid.inlinedit", "fmatter", "textbox", "toolbar",
		...
		"dialog", "messager", "form", "tabs", "tree", "layout", "menu", "swfobject", "swfupload", "swfuploader",
