...
function _override_form (ui) {
	...
	if(2 === ui.options.number){
		ui.clickAdd = function(){
			...
			//计算总重量添加到主表表单内
			var value = formData.CHENGJIAOJINE;
			var masterForm = ui.getMasterForm();
			var masterFormData = $('form',masterForm.uiForm).form('formData',false);
			masterFormData.CHENGJIAOJINE = Number(masterFormData.CHENGJIAOJINE) + Number(value);
			
			$('form',masterFormData.uiForm).form('loadData',masterFormData);
		    // 重置表单数据
			this.reset();
		};
	};
