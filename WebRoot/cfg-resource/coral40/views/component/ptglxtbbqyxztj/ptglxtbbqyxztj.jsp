...
<head>
    ...
    <script type="text/javascript">
        var chartData = $.loadJson($.contextPath+'/trace!getQyxztj.json?csrq=month');
        $(function () {
        ...
        $.extend($.ns("namespaceId${idSuffix}"), {
            initCharts:function(){
                ...
                $('#zjqt${idSuffix}').click(function(){
                    chartData = $.loadJson($.contextPath+'/trace!getQyxztj.json?csrq=week');
                    query();
                });
                $('#zjsst${idSuffix}').click(function(){
                    chartData = $.loadJson($.contextPath+'/trace!getQyxztj.json?csrq=month');
                    query();
                });
                $('#search${idSuffix}').click(function(){
                    ...
                    chartData = $.loadJson($.contextPath+'/trace!getQyxztj.json?csrq='+csrq+'&jzrq='+jzrq);
                    query();
                });
