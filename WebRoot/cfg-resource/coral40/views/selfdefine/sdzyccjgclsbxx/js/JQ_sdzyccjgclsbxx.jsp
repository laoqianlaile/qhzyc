...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzyccjgclsbxx";
};
...
function _override_form (ui) {
    ...
    ui.bindEvent = function(){
        var xh = ui.getItemJQ("XH");
        xh.combogrid("option","onChange",function(e,data){
            var rowData =xh.combogrid("grid").grid("getRowData",data.value);
            ui.setFormData({XH:rowData.XH,SBH:rowData.SBSBH });
        });
    }
	// ui.assembleData 就是 configInfo
	//ui.bindEvent = function () {
