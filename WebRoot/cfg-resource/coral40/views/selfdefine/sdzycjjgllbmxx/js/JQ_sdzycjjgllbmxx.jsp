...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycjjgllbmxx";
};
...
function _override_form (ui) {
	...
	ui._init = function() {
		...
		ui.getItemJQ("BMFZR").combogrid("reload",$.contextPath+"/zzgzryda!getGzrydaGrid.json?dwlx=JJGQY");
	}
