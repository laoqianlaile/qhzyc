...
Public Sub mnuFileNew_click()
	If CellWeb.IsModified() Then '文档已经被更改
...
Public Sub mnuFileWebOpen_click()
	...
	If strFilename <> "" Then CellWeb.OpenFile strFilename, ""
End Sub
...
Public Sub mnuFileSheetSaveAs_click()
	CellWeb.SaveSheet CellWeb.GetCurSheet
End Sub

'读入文本文件
Public Sub mnuFileImportText_click()
	CellWeb.ImportTextDlg
End Sub
...
Public Sub mnuFileImportCSV_click()
	...
	If Err <> 32755 Then    ' 用户选择“取消”。
		...
		CellWeb.ImportCSVFile strOpenFileName, CellWeb.GetCurSheet()
	End If
End Sub 

'读入Excel文件
Public Sub mnuFileImportExcel_click()
	CellWeb.ImportExcelDlg
End Sub

'输出文本文件
Public Sub mnuFileExportText_click()
	CellWeb.ExportTextDlg
End Sub
...
Public Sub mnuFileExportCSV_click()
	...
	End If
	If Filename <> "" Then
		CellWeb.ExportCSVFile Filename, CellWeb.GetCurSheet()
	End If
End Sub

'输出Excel文件
Public Sub mnuFileExportExcel_click()
	CellWeb.ExportExcelDlg
End Sub
...
Public Sub mnuFileExportPDF_click()
	...
	If Filename <> "" Then
		Dim CurSheet
		Dim Pages
		CurSheet = CellWeb.GetCurSheet()
		Pages = CellWeb.PrintGetPages(CurSheet)
		CellWeb.ExportPdfFile Filename, CurSheet, 0, Pages
	End If
End Sub

'页面设置
Public Sub mnuFilePageSetup_click()
	CellWeb.PrintPageSetup
End Sub

'打印预览
Public Sub mnuFilePrintPreview_click()
	CellWeb.PrintPreview True, CellWeb.GetCurSheet
End Sub

'打印
Public Sub mnuFilePrint_click()
	CellWeb.PrintSheet True, CellWeb.GetCurSheet
End Sub

'退出
Public Sub mnuFileExit_click()
	If CellWeb.IsModified() Then
		rtn = MsgBox( "文档已被更改，是否保存？", vbExclamation or vbYesNoCancel)
		If rtn = vbYes Then
			mnuFileSave_click
		ElseIf rtn = vbCancel Then
...
Public Sub mnuEditCut_click()
 	CellWeb.GetSelectRange Startcol, Startrow, Endcol, Endrow
    	CellWeb.CutRange Startcol, Startrow, Endcol, Endrow
End Sub

'复制操作
Public Sub mnuEditCopy_click()
 	CellWeb.GetSelectRange Startcol, Startrow, Endcol, Endrow
    	CellWeb.CopyRange Startcol, Startrow, Endcol, Endrow
End Sub

'粘贴操作
Public Sub mnuEditPaste_click()
 	CellWeb.Paste CellWeb.GetCurrentCol, CellWeb.GetCurrentRow, 0, False, False
End Sub

'选择性粘贴
Public Sub mnuEditPasteSpecial_Click()
	CellWeb.PasteSpecialDlg
End Sub

'查找
Public Sub mnuEditFind_click()
	CellWeb.FindDialog 0
End Sub

'替换
Public Sub mnuEditReplace_click()
	CellWeb.FindDialog 1
End Sub
...
Public Sub mnuEditFillV_click()
	CellWeb.FillBetweenSheet
End Sub

'插入特殊符号
Public Sub mnuEditInsertSpeChar_click()
	CellWeb.InsertSpecialCharDlg
End Sub

'超级链接
Public Sub mnuEditHyperlink_click()
	CellWeb.HyperlinkDlg
End Sub
...
Public Sub mnuViewFreezed_click()
	If IsFreezed Then
		CellWeb.SetFixedCol 0, -1
        	CellWeb.SetFixedRow 0, -1
        Else
        	CellWeb.SetFixedCol 1, CellWeb.GetCurrentCol - 1
        	CellWeb.SetFixedRow 1, CellWeb.GetCurrentRow - 1
        End If
End Sub
...
Public Sub mnuFormatRemovePic_click()
	...
	For col =  Startcol to Endcol
		For row = Startrow to Endrow
			CellWeb.RemoveCellImage col, row, curSheet
		Next
	Next
End Sub
...
Public Sub mnuFormatMergeCell_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	CellWeb.MergeCells StartCol, StartRow, EndCol, EndRow
End Sub
...
Public Sub mnuFormatUnMergeCell_click()
	...
	For col = StartCol To EndCol
		For row = StartRow To EndRow
		    CellWeb.GetMergeRange col, row, StartCol1, StartRow1, EndCol1, EndRow1
		    CellWeb.UnmergeCells StartCol1, StartRow1, EndCol1, EndRow1
		Next
	Next
End Sub

Public Sub menuAddRowCompage_click()
CellWeb.GetSelectRange col1,row1,col2,row2
CellWeb.AddRowCompages row1,row2 
End Sub

Public Sub menuDelRowCompage_click()
CellWeb.GetSelectRange col1,row1,col2,row2
CellWeb.DeleteRowCompages row1,row2 
End Sub

Public Sub menuAddColCompage_click()
CellWeb.GetSelectRange col1,row1,col2,row2
CellWeb.AddColCompages col1,col2 
End Sub

Public Sub menuDelColCompage_click()
CellWeb.GetSelectRange col1,row1,col2,row2
CellWeb.DeleteColCompages col1,col2 
End Sub

Public Sub menuDelAllCompage_click()
CellWeb.RemoveAllCompages
End Sub       
...
Public Sub mnuRowInsert_click()
	CellWeb.InsertRowDlg
End Sub

'删除表行
Public Sub mnuRowDelete_click()
	CellWeb.DeleteRowDlg
End Sub

'追加表行
Public Sub mnuRowAppend_click()
	CellWeb.AppendRowDlg
End Sub

'行高
Public Sub mnuRowHeight_click()
	CellWeb.RowHeightDlg
End Sub

'隐藏行
Public Sub mnuRowHide_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	CellWeb.SetRowHidden StartRow, EndRow
End Sub

'取消隐藏行
Public Sub mnuRowUnhide_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	CellWeb.SetRowUnhidden StartRow, EndRow
End Sub
...
Public Sub mnuColInsert_click()
	CellWeb.InsertColDlg
End Sub

'删除表列
Public Sub mnuColDelete_click()
	CellWeb.DeleteColDlg
End Sub

'追加表列
Public Sub mnuColAppend_click()
	CellWeb.AppendColDlg
End Sub
...
Public Sub mnuColHide_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	CellWeb.SetColHidden StartCol, EndCol
End Sub

'取消隐藏列
Public Sub mnuColUnhide_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	CellWeb.SetColUnhidden StartCol, EndCol
End Sub
...
Public Sub mnuSheetRename_click()
	CellWeb.SheetLabelRenameDlg
End Sub

'表页尺寸
Public Sub mnuSheetSize_click()
	CellWeb.SetSheetSizeDlg
End Sub
...
Public Sub cmdSortAscending_click()
	...
	If StartRow = EndRow And StartCol <> EndCol Then
		CellWeb.SortRow 1, StartRow, StartCol, StartRow, EndCol, EndRow
	ElseIf StartCol = EndCol And StartRow <> EndRow Then
		CellWeb.SortCol 1, StartCol, StartCol, StartRow, EndCol, EndRow
...
Public Sub cmdSortDescending_click()
	CellWeb.GetSelectRange StartCol, StartRow, EndCol, EndRow
	If StartRow = EndRow And StartCol <> EndCol Then
		CellWeb.SortRow 0, StartRow, StartCol, StartRow, EndCol, EndRow
	ElseIf StartCol = EndCol And StartRow <> EndRow Then
		CellWeb.SortCol 0, StartCol, StartCol, StartRow, EndCol, EndRow
	ElseIf StartRow <> EndRow And StartCol <> EndCol Then
		mnuDataRangeSort_Click
	End If
End Sub
...
'设置右键菜单
Public Sub CellWeb_MenuStart( ByVal col, ByVal row, ByVal section)
With CellWeb
...
'右键菜单命令
Public Sub CellWeb_MenuCommand(ByVal col, ByVal row, ByVal itemid)
    '单元格中的右键菜单
    With CellWeb
        Select Case itemid
            ...
            Case 1006: CellWeb.FormatPainter			'格式刷
...
Public Sub changeViewScale( ByVal value )
	zoom = value/100.0
	CellWeb.SetScreenScale CellWeb.GetCurSheet, zoom
End Sub
