<%@ tag language="java" pageEncoding="UTF-8"%><%@attribute name="id"%><%@ attribute name="cls" %><%@ attribute name="componentCls" %><%@ attribute name="rendered" type="java.lang.Boolean" %><%@ attribute name="authorized" %><%@ attribute name="loadui" %><%@ attribute name="sortname" %><%@ attribute name="sortorder" %><%@ attribute name="allowSaveOnError" type="java.lang.Boolean"%><%@ attribute name="rowEditButtons"%><%@ attribute name="treeGrid" type="java.lang.Boolean"%><%@ attribute name="minWidth" type="java.lang.Boolean"%><%@ attribute name="clicksToEdit"%><%@attribute name="rowattr"%><%@attribute name="cellattr"%><%@attribute name="frozenColumns" type="java.lang.Boolean" %><%@attribute name="autoencode" type="java.lang.Boolean" %><%@attribute name="jsonReader"%><%@attribute name="groupingView"%><%@attribute name="grouping" type="java.lang.Boolean" %><%@attribute name="loadtext"%><%@attribute name="loadonce" type="java.lang.Boolean" %><%@attribute name="rowList"%><%@attribute name="multikey"%><%@attribute name="afterInlineSaveRow"%><%@attribute name="beforePopulate"%><%@attribute name="beforeInlineEditRow"%><%@attribute name="afterInlineSave"%><%@attribute name="afterInlineCancelRow"%><%@attribute name="pagerStyle"%><%@attribute name="pagerTemplate"%><%@attribute name="recordtext"%><%@attribute name="rninput"%><%@attribute name="altRows" type="java.lang.Boolean"%><%@attribute name="altclass"%><%@attribute name="beforeEditCell"%><%@attribute name="afterEditCell"%><%@attribute name="afterSaveCell"%><%@attribute name="onInlineEditRow"%><%@attribute name="afterFilter"%><%@attribute name="width"%><%@attribute name="height"%><%@attribute name="url"%><%@attribute name="caption"%><%@attribute name="data"%><%@attribute name="initData"%><%@attribute name="onLoad"%><%@attribute name="onComplete"%><%@attribute name="shrinkToFit" type="java.lang.Boolean"%><%@attribute name="singleselect" type="java.lang.Boolean"%><%@attribute name="forceFit" type="java.lang.Boolean"%><%@attribute name="onSortableColumns" %><%@attribute name="beforeSortableRows" %><%@attribute name="onSortableRows" %><%@attribute name="afterSortableRows" %><%@attribute name="editableRows" type="java.lang.Boolean" %><%@attribute name="onPaging"%><%@attribute name="onMouseEnter"%><%@attribute name="onMouseLeave"%><%@attribute name="onDblClickRow"%><%@attribute name="onResizeStop"%><%@attribute name="onResizeStart"%><%@attribute name="onSelectRow"%><%@attribute name="beforeSelectRow"%><%@attribute name="onSelectCell"%><%@attribute name="onSelectAll"%><%@attribute name="rownumbers" type="java.lang.Boolean"%><%@attribute name="rowNum"%><%@attribute name="rownumWidth"%><%@attribute name="groupHeader" type="java.lang.Boolean"%><%@attribute name="model"%><%@attribute name="picTemplate"%><%@attribute name="multiselect" type="java.lang.Boolean"%><%@attribute name="repeatitems" type="java.lang.Boolean"%><%@attribute name="postData"%><%@attribute name="fitStyle"%><%@attribute name="datatype"%><%@attribute name="asyncType"%><%@attribute name="viewrecords" type="java.lang.Boolean"%><%@attribute name="navbarOptions"%><%@attribute name="cellEdit" type="java.lang.Boolean"%><%@include file="TagUtil.jsp" %><% 
...
%><div <%=(id == null ? "" : "id="+id) %> class="<%=cls==null?"":cls%>" data-options="<%=option %>" >
<jsp:doBody />
</div>
<script <%= "id=" + id + "_s" %>>
Coral.cc("grid", "<%= id%>");
