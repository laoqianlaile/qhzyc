...
$.component( "coral.autocomplete", $.coral.control,{
	version: "4.0.2",
			...
			if ( text instanceof Array ) {
				if ( maxLabelWidth == "auto" || isLabel || readonly ){
					$.each(text, function(i){
						text.splice(i,1,"<li tabindex='-1' class='coral-textboxlist-item'  title='"+this+"'>"+this+"<span class='coral-label-close icon icon-close2'></span></li>");
					});
				}else{
					$.each(text, function(i){
						text.splice(i,1,"<li tabindex='-1' class='coral-textboxlist-item'  style='  max-width:"+maxLabelWidth+"px;' title='"+this+"'>"+this+"<span class='coral-label-close icon icon-close2'></span></li>");
					});
				}
				item = text.join("");
			} else {
				if ( maxLabelWidth == "auto"|| isLabel || readonly){
					item = "<li tabindex='-1' class='coral-textboxlist-item'   title='"+this+"' >"+text+"<span class='coral-label-close icon icon-close2'></span></li>";
				}else{
					item = "<li tabindex='-1' class='coral-textboxlist-item'  style='  max-width:"+maxLabelWidth+"px;' title='"+this+"' >"+text+"<span class='coral-label-close icon icon-close2'></span></li>";
				}
			}
			if ( text != "" ) {
				if ( this.options.multiple ) {
