...
$.extend(Datepicker.prototype, {
	...
	_init : function(target,inst){
		...
		var span2=$("<span id='"+id+"_span2' class='coral-textbox-border coral-corner-all'></span>");
	...
	_attachments: function(input, inst) {
		...
		if (showOn === "button" || showOn === "both") {
			...
			inst.trigger = $("<span/>").addClass("coral-icon-calendar icon icon-calendar4");
...
W W	同上，如果小于两位数，前面补零 (01 - 53) 。
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			" title='" + prevText + "'><span class='icon  icon-arrow-" + ( isRTL ? "right2" : "left") + "'></span></a>" :
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			" title='" + nextText + "'><span class='icon  icon-arrow-" + ( isRTL ? "left" : "right2") + "'></span></a>" :
