...
<div class="yca">
	...
	<div class="zycas">
		...
		<div class="xzdh" onclick="">

		</div>
		<div class="ycb_loginbar" style="top: 60px;">
			<dl style="padding-top:10px">
				<dt><a href="javascript:void(0)" style="text-align: center">
	...
	<!--初始下页面-->
	<div class="zycax"  id ="zycax" style="">
		<ul>
			<li class="city"><a href="javascript:void(0)" onclick="menuClick('企业信息','/cfg-resource/coral40/views/component/zxtqyda/zxtqyda.jsp?constructId=402881e64db782f4014db79374c00002&bindingType=menu&menuId=402880f1552361370155239d0f7e0008&componentVersionId=402881e64db782f4014db79374a60001&menuCode=ZYYQY&topComVersionId=402881e64db782f4014db79374a60001','402880f1552361370155239d0f7e0008',this)">企业信息 <i></i></a></li>
			<li><a href="javascript:void(0)"onclick="menuClick('供应商信息','/cfg-resource/coral40/views/selfdefine/zyyypgysxx/MT_component.jsp?P_moduleId=402881f258cdf5020158ce05bac00021&constructId=402881f258cdf5020158ce0725e6002a&bindingType=menu&menuId=402881f258cdf5020158ce26e1480088&componentVersionId=402881f258cdf5020158ce0725df0029&menuCode=YPGYSXX&topComVersionId=402881f258cdf5020158ce0725df0029','402881f258cdf5020158ce26e1480088',this)">供应商信息 <i></i></a></li>
			<li><a href="javascript:void(0)"onclick="menuClick('饮片进场','/cfg-resource/coral40/views/selfdefine/sdszyysmjc/MT_component.jsp?P_moduleId=8a8009bc58f724a20158f74722ef000d&constructId=8a8009bc58f724a20158f748635c0016&bindingType=menu&menuId=402880f1552361370155239fef97000a&componentVersionId=8a8009bc58f724a20158f748635a0015&topComVersionId=8a8009bc58f724a20158f748635a0015','402880f1552361370155239fef97000a',this)">饮片信息 <i></i></a></li>
		</ul>
	</div>
	<!--点击跳转页面-->
	<div class="zycx" id="mainContent">
...
<script type="text/javascript">
	...
	function menuClick(name, url, id) {
	   /* var a=document.getElementById(zycax);
	...
	$(function () {
		...
		$.each(data, function (i, menuA) {
			if (!menuA) return;
				if(menuA.code == "jcxx"){
                    ermenu = '<dl>'+
                        '<dt><a href="javascript:void(0)"><h4>基础信息</h4></a></dt>'
					ermenu+=initMenu(menuA);
                    ermenu +='</div></dl>';
                    $('.xzdh').append(ermenu);
				}else if(menuA.code == "jcxxx"){//粗加工菜单样式
                    ermenu = '<dl>'+
				             '<dt><a href="javascript:void(0)"><h4>进场管理</h4></a></dt>'
					ermenu+=initMenu(menuA);
                    ermenu +='</div></dl>';
                    $('.xzdh').append(ermenu);
				}
		...
		$(".yca li").click(function () {
                $(this).addClass("city").siblings().removeClass("city")
            $(this).parents().siblings("dl").children("div").hide()
            })

            $(".xzdh dt").click(function(){
		...
		function initMenu(menuA) {
				...
				$.each(menuA.items, function (j, menuB) {
					var menuContentC = '<dd> <a href="javascript:void(0)" onclick="menuClick(\'' + menuB.name + '\',\'' + menuB.url + '\',\'' + menuB.id + '\',this)"><h5>'+menuB.name+'</h5></a></dd>';
					menuContent+=menuContentC;
				});
				return menuContent;
