...
{
%>
<jsp:forward page="WEB-INF/layouts/trace_yxt_menu.jsp"></jsp:forward>
<%
}else if("000007804".equals(companyCode))
{
%>
<jsp:forward page="WEB-INF/layouts/trace_ylzy_menu.jsp"></jsp:forward>
<%
}else if("000007784".equals(companyCode))
{
%>
<jsp:forward page="WEB-INF/layouts/trace_kpny_menu.jsp"></jsp:forward>
<%
...
{
%>
<jsp:forward page="WEB-INF/layouts/trace_dlh_menu.jsp"></jsp:forward>
<%
...
<%
} else if ("dhtmlx".equals(SystemParameterUtil.getInstance().getReleaseSystemUI())) {
%>
