...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/ycjxxz";
};
...
function _override_form (ui) {
	...
	ui.bindEvent = function(){
		...
		qypch.combobox("option","onChange",function(e,data){
		var jsonData = $.loadJson( $.contextPath +"/ycjxxz!searchYcpch.json?qypch="+data.value);
		ui.setFormData({PCH:jsonData[0].PCH,JYZL:jsonData[0].RKZL,YCDM:jsonData[0].YCDM,CSPCH:jsonData[0].CSPCH,QYPCH:jsonData[0].QYPCH,YPMC:jsonData[0].YCMC});
		});
