...
<div class="sdyc dme">
    ...
    <div class="sdyc_header">
        <!--logo-->
        <span class="sd_lo sd_log"><img src="<%=contextPath %>/cfg-resource/coral40/common/themes/qhzyc/images/dme.png" alt=""></span>
        <div class="sdyc_logo">
            <h4>帝玛尔中药材饮片流通追溯系统</h4>
        </div>
        <!--loginbar-->
        <div class="sdyc_login_bar">
            ...
            <a href="javascript:void(0)"onclick="changePassword()">
                <span class="yellow">当前用户</span><span><%=name%>
            </a>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(contextPath + "/menu/menu!loadAppMenuForCoral40.json?systemId=" + systemId + "&P_timestamp=" + getTimestamp(), function (data) {
            ...
            var cjgdata ='';
            var jjgdata ='';
            /*$('.logo').append('<img src="<%=contextPath %>/cfg-resource/coral40/common/themes/login/css/images/content/sdyca.jpg">');*/
            ...
            $.each(data, function (i, menuA) {
                ...
                if(menuA.code == "zz"){//种植菜单样式
                    onemenus += '<li class="li1" onmouseenter=oneli()><a href="javascript:void(0)"><span><svg class="icon" aria-hidden="true"><use xlink:href="#icon-shiliangzhinengduixiang7"></use>	</svg>'+
                        menuA.name+
                        '</span></a></li>' ;
                    zzdata = menuA.items;
                }else if(menuA.code == "cjg"){//粗加工菜单样式
                    onemenus += '<li class="li2" onmouseenter=towli()><a href="javascript:void(0)"><span><svg class="icon" aria-hidden="true"><use xlink:href="#icon-shiliangzhinengduixiang1"></use>	</svg>'+
                        menuA.name+
                        '</span></a></li>' ;
                    cjgdata = menuA.items;
                }else if(menuA.code == "jjg"){
                    onemenus += '<li class="li3" onmouseenter=threeli()><a href="javascript:void(0)"><span><svg class="icon" aria-hidden="true"><use xlink:href="#icon-shiliangzhinengduixiang3"></use>	</svg>'+
                        menuA.name+
                        '</span></a></li>' ;
                    jjgdata = menuA.items;
                }
