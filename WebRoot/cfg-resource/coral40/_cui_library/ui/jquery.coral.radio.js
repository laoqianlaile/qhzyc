...
$.component( "coral.radio", {
    ...
    _create: function() {
		...
		if (that.options.checked) {
			...
			that.uiIcon.addClass("icon icon-radio-checked");
			that.element.prop("checked", true);
		} else {
			that.uiIcon.addClass("icon icon-radio-unchecked");
	...
	_bindEvent: function() {
		...
		this.uiLabel.bind("click" ,function(e){
			...
			if ( !that.options.isCheck ) {
				...
				that.uiIcon.removeClass("icon-radio-unchecked");
				that.uiIcon.addClass("icon-radio-checked");
				that.element.prop("checked", true);
	...
	_clearCheckedState: function(){
		this._getRadios().each(function(){
			$(this).radio("component").find(".coral-radio-icon").removeClass("icon-radio-checked").addClass(" icon-radio-unchecked");
		});
	},
	// hash code
	...
	check : function() {
		...
		if (this.uiIcon.hasClass("icon-radio-unchecked")) {
			that._getRadios().each(function(){
				$(this).radio("component").find(".coral-radio-icon").removeClass("icon-radio-checked").addClass(" icon-radio-unchecked");
			});
			this.uiIcon.removeClass("icon-radio-unchecked").addClass("icon-radio-checked");
			this.element.prop("checked", true);
		}		
	},
	uncheck : function() {
		if (this.uiIcon.hasClass("icon-radio-checked")) {
			this.uiIcon.removeClass("icon-radio-checked").addClass("icon-radio-unchecked");
