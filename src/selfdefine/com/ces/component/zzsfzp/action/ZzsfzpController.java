package com.ces.component.zzsfzp.action;
...
import com.ces.component.zzsfzp.service.ZzsfzpService;
...
public class ZzsfzpController extends TraceShowModuleDefineServiceDaoController<StringIDEntity, ZzsfzpService, TraceShowModuleDao> {

    private static final long serialVersionUID = 1L;
    private static Log log = LogFactory.getLog(ZzsfzpController.class);
    /*
     * (非 Javadoc)   
     * <p>标题: initModel</p>   
     * <p>描述: </p>      
