...
<div id="max${idSuffix}" class="fill">
  <div class="fill">
    <div class="toolbarsnav clearfix">
      ...
      <div class='homeSpan' style="margin-top: -23px;"><div><div style='margin-left:20px;width: 150px;' id="nva${idSuffix}"> - 投入品信息 - 新增 </div></div></div>
    </div>
    <form id="trplyForm${idSuffix}" method="post" class="coralui-form">
      ...
      <div class="fillwidth colspan2 clearfix">
        ...
        <div class="app-inputdiv6"  style="display: none">
          ...
          <input id="TRPBH${idSuffix}" name="TRPBH" data-options="maxlength:50"  class="coralui-textbox"/>
        </div>
        ...
        <div class="app-inputdiv6">
          ...
          <input id="TRPMC${idSuffix}" name="TRPMC" class="coralui-textbox" data-options="required:true , maxlength:50" />
        </div>

        <div id="PP1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >品牌：</label>
          <input id="PP${idSuffix}" name="PP"  data-options="required:true,maxlength:50" class="coralui-textbox" />
        </div>
        <div id="ML1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >马力：</label>
          <input id="ML${idSuffix}" name="ML"  data-options="required:true,maxlength:50" class="coralui-textbox"/>
        </div>
        <div id="XH1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >型号：</label>
          <input id="XH${idSuffix}" name="XH"  data-options="required:true,maxlength:50" class="coralui-textbox"/>
        </div>

        <div id="TYM1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >通用名：</label>
          <input id="TYM${idSuffix}" name="TYM"  data-options="required:true,maxlength:50" class="coralui-textbox"/>
        </div>
        <div id="BZGG1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >包装规格：</label>
          <div class="min-div">
            <input id="BZGG${idSuffix}" name="BZGG" data-options="required:true,maxlength:50,pattern:'//^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$//',errMsg:'请输入正实数'" class="coralui-textbox"/>
          </div>
        ...
        <div id="TJYL1${idSuffix}" class="app-inputdiv6">
          ...
          <input id="TJYL${idSuffix}" name="TJYL"  data-options="required:true,maxlength:50,pattern:'//^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$//',errMsg:'请输入正实数'" class="coralui-textbox"/>
        </div>
        <div id="YT1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >用途：</label>
          <input id="YT${idSuffix}" name="YT"  data-options="required:true,maxlength:50" class="coralui-textbox"/>
        </div>
        <div id="ZXBZ1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >执行标准：</label>
          <input id="ZXBZ${idSuffix}" name="ZXBZ"data-options="maxlength:50" class="coralui-textbox"/>
        </div>
        <div id="YXCF1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >有效成分：</label>
          <input id="YXCF${idSuffix}" name="YXCF"  data-options="required:true,maxlength:50" class="coralui-textbox"/>
        </div>
        <div id="AQQ1${idSuffix}" class="app-inputdiv6">
          <label class="app-input-label" >安全期(天)：</label>
          <input id="AQQ${idSuffix}" name="AQQ"  data-options="required:true,validType:'integer',maxlength:50" class="coralui-textbox"/>
        </div>
        ...
        <div class="app-inputdiv12" id="line22${idSuffix}">
          <label class="app-input-label">备注：</label>
          <textarea id="BZ${idSuffix}" name="BZ"  data-options="maxlength:500" class="coralui-textbox"/>
        </div>
