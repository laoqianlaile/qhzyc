...
<div class="toolbarsnav clearfix">
    <div class="coral-toolbar-item-component coral-toolbar-html ctrl-toolbar-element" group="upper left" data-frozen="true" style="right: auto; left: 0px;">
        <h1>
                <span class="homeSpan" style="padding-left: 30px;"> - 药材销售量统计
                </span>
        </h1>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $.extend($.ns("namespaceId${idSuffix}"), {
        toolbarClick : function ( e , ui ){
            ...
            if( ui.id == 'search' ){
                ...
                var jsonData = $.loadJson($.contextPath + "/sdzyccjgycxsltj!searchj.json?kssj="+$formData.KSSJ+"&jssj="+$formData.JSSJ+"&rqlx="+$formData.RQLX+"&cpmc="+$formData.CPMC);
    ...
    $(function() {
        var configInfo = CFG_initConfigInfo({
            /** 页面名称 */
            'page' : 'sdzyccjgycxsltj.jsp',//入库量趋势分析页面
            /** 页面中的最大元素 */
