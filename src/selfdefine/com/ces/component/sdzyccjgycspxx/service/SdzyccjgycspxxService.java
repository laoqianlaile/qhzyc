package com.ces.component.sdzyccjgycspxx.service;
...
@Component
public class SdzyccjgycspxxService extends TraceShowModuleDefineDaoService<StringIDEntity, SdzyccjgycspxxDao> {
    public String saveycspxx(List<Map<String,String>> dataList){
        if( null != dataList && dataList.size() > 0){
            StringBuffer sbf = new StringBuffer();
            for( Map<String,String> dataMap : dataList){
                String zsspm = dataMap.get("ZSSPM");
                String sql = "select count(0)  count from t_sdzyc_zycspbm where  is_delete = '0' and qylx='CJG' and zsspm=? "+defaultFilter();
    ...
    protected String buildCustomerFilter(String tableId, String componentVersionId, String moduleId, String menuId, Map<String, Object> paramMap) {
        ...
        if (isQybmColumnExist) {
            ...
            filter.append(AppDefineUtil.RELATION_AND + " qylx = 'CJG' ");
        }
    ...
    public Map<String,Object> searchYclComboGridData() {
        ...
        String sql = "select * from T_SDZYC_ZYCSPBM t where t.qylx = 'CJG' and t.qybm= '"+companyCode+"'";
