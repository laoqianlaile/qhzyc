...
<div id="max${idSuffix}" class="fill">
    <div id="ft${idSuffix}" class="toolbarsnav clearfix top0">
        ...
        <div class='homeSpan' style="margin-top: -23px;">
            <div>
                <div style='margin-left:20px;width: 150px;' id="nva${idSuffix}"> -工作人员信息-新增</div>
            </div>
        </div>
    </div>
    <form id="enterForm${idSuffix}" action="${basePath}"
        ...
        <div class="fillwidth colspan3 clearfix">
            ...
            <input id="gzrybh${idSuffix}" data-options="readonly:true" name="gzrybh" type="hidden"
                   class="coralui-textbox"/>
            <div class="app-inputdiv4">
                <label class="app-input-label" style="width:20%;">姓名:</label>
                <input id="xm${idSuffix}" data-options="required:true" maxlength="20" name="xm"
                       class="coralui-textbox"/>
            </div>
            <div class="app-inputdiv4">
            ...
            <div class="app-inputdiv4">
                ...
                <input id="lxfs${idSuffix}" name="lxfs" data-options="validType:'mobile',required:true  "
                       class="coralui-textbox"/>
            </div>
        </div>
        <div class="fillwidth colspan3 clearfix">
            <div class="app-inputdiv4">
                ...
                <input id="xb${idSuffix}" name="xb" autocomplete="off"  class="coralui-radiolist" data-options="value:'1',column:2,data:[{value:'1',text:'男'},{value:'2',text:'女'}]">
            </div>
            <div class="app-inputdiv4">
                <label class="app-input-label" style="width:20%;">岗位:</label>
                <input id="gw${idSuffix}" name="gw" data-options="required:true" autocomplete="off"
                       class="coralui-combobox" placeholder="请选择">
            </div>
            <div class="app-inputdiv4">
