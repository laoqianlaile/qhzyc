    ...
    _render: function() {
        ...
        this.element.find('li').each(function() {
	        ...
	        if(listItem.children('ul').length > 0) {
	            ...
	            menuitemLink.find(".coral-navigationmenu-item-inner").prepend('<span style="float:left;" class="cui-icon-arrow-down3"></span>');
	        } else if($this.options.textAlign == 'right'){
	            menuitemLink.find(".coral-navigationmenu-item-inner").prepend('<span style="float:left;visibility:hidden;" class="cui-icon-arrow-down3"></span>');
	        }
