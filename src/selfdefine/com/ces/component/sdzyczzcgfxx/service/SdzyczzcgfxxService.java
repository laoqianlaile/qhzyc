package com.ces.component.sdzyczzcgfxx.service;
...
import com.ces.component.sdzyczzcgfxx.dao.SdzyczzcgfxxDao;
...
@Component
public class SdzyczzcgfxxService extends TraceShowModuleDefineDaoService<StringIDEntity, SdzyczzcgfxxDao> {
    public Map<String, String> save(String tableId, String entityJson, Map<String, Object> paramMap) {
        ...
        if (StringUtil.isEmpty(id)) {//是新增操作
            String flbh = SerialNumberUtil.getInstance().getSerialNumber("SDZYC", "SDZYCZZCGFXX", false);
    ...
    public Object getGzryda() {
        ...
        String sql="select t.CGSBH,t.CGSMC from T_SDZYC_CGFXX t where t.qybm = ? and t.is_delete = '0'";
