...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycjjgckxx";
};
...
function _override_form (ui) {
	...
	ui._init = function(){
		...
		ui.getItemJQ("FZR").combogrid("reload",$.contextPath+"/zzgzryda!getGzrydaGrid.json?dwlx=JJGQY");//判断下来框的值
	}
	...
	//精加工仓库信息负责人回调
	ui.addCallback("setComboGridValue_ckfzr",function(o){
		if (null == o) return;
