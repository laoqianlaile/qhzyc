package com.ces.component.cycpjcxx.service;
...
@Component
public class CycpjcxxService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {
    ...
    public List<String> saveCpData(String barCode){
        ...
        if (!jyxx.isEmpty()) {
            ...
            String jcId = save("T_CY_CPJCXX", dataMap, null);
