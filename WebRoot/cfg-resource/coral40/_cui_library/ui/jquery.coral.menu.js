...
$.component("coral.navigationmenu", $.coral.basemenu,{
    ...
    _render: function() {
        ...
        this.element.find('li').each(function() {
	        ...
	        .contents().wrap('<span class="coral-menuitem-text" />');
	        //menuitemLink.attr( "data-target", menuitemLink.attr("href") );
	        ...
	        if(listItem.children('ul').length > 0) {
	            ...
	            menuitemLink.prepend('<span style="float:left;" class="coral-icon-arrow-down icon icon-arrow-down2"></span>');
	        ...
	        if($this.options.textAlign == 'right'){
	            $("<span class='coral-empty' style='width:"+level*16+"px;height:"+16+"px;'></span>").prependTo(menuitemLink);
	        }
