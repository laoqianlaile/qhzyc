package com.ces.component.cjgycjyqyzj.service;
...
@Component
public class CjgycjyqyzjService extends TraceShowModuleDefineDaoService<StringIDEntity, CjgycjyqyzjDao> {
  /*  @Override
    public Map<String, String> save(String tableId, String entityJson, Map<String, Object> paramMap) {
        ...
        String sql = "update t_Sdzyc_Cjg_Ycjgxx  set JYJG=1 where JGPCH='"+ PCH+"'";
