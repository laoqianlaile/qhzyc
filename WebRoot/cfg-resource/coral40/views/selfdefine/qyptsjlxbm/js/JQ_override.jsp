...
function _override_form (ui) {
	...
	//};
	ui._init= function(){
		var lxbm = ui.getItemJQ("LXBM");
		ui.setFormData({LXBM:CFG_getInputParamValue(ui.assembleData, 'lxbm')});
	}
...
function _override_grid (ui) {
	...
	ui.beforeInitGrid = function (setting){
		setting.url = $.contextPath + '/qyptsjlxbm!getGridData.json?lxbm='+lxbm;
		return setting;
	};
