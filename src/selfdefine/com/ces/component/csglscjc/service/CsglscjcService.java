package com.ces.component.csglscjc.service;
...
@Component
public class CsglscjcService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {
...
//            }
        ...
        return AppDefineUtil.RELATION_AND+" LSXZQHDM like '310%' ";
    }
}