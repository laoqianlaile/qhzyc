...
<div class="sdyc jk">
    ...
    <div class="sdyc_header">
        <!--logo-->
        <span class="sd_lo "><img src="<%=contextPath %>/cfg-resource/coral40/common/themes/qhzyc/images/logo1.png" alt=""></span>
        <div class="sdyc_logo">
            <h4>帝普生物中药材饮片流通追溯系统</h4>
        </div>
        <!--loginbar-->
