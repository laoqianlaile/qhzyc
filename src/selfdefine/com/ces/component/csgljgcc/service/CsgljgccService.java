package com.ces.component.csgljgcc.service;
...
@Component
public class CsgljgccService extends TraceShowModuleDefineDaoService<StringIDEntity, TraceShowModuleDao> {
    @Override
...
//            }
        ...
        return AppDefineUtil.RELATION_AND+" LSXZQHDM like '31%'";
