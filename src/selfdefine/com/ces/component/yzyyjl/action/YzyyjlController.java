package com.ces.component.yzyyjl.action;
...
import com.ces.component.yzyyjl.service.YzyyjlService;
...
public class YzyyjlController
		extends
		TraceShowModuleDefineServiceDaoController<StringIDEntity, YzyyjlService, TraceShowModuleDao> {

	private static final long serialVersionUID = 1L;
	private static Log log = LogFactory.getLog(YzyyjlController.class);

	/*
	 * (非 Javadoc) <p>标题: initModel</p> <p>描述: </p>
	 * 
