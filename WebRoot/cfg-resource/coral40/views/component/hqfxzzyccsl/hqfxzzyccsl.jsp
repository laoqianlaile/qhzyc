    ...
    <ces:form id="form${idSuffix}" name="form">
        <div class="fillwidth colspan3 clearfix ">
            ...
            <div class="app-inputdiv8">
                <label class="app-input-label">结束日期：</label>
            ...
            <div class="app-inputdiv4">
                <label class="app-input-label">药材名称：</label>
                <input id="ycmc${idSuffix}" name="YCMC"/>
            </div>
            <div class="app-inputdiv4">
                <label class="app-input-label">查看企业：</label>
                <input id="ckqy${idSuffix}" name="CKQY"/>
            </div>
        </div>
    </ces:form>
    <div class="fillwidth colspan3 clearfix ">
...
<script type="text/javascript">
    ...
    $.extend($.ns("namespaceId${idSuffix}"), {
        toolbarClick : function ( e , ui ){
            ...
            if( ui.id == 'search' ){
                ...
                var jsonData = $.loadJson($.contextPath + "/hqfxzzyccsl!searchj.json?kssj="+$formData.KSSJ+"&jssj="+$formData.JSSJ+"&rqlx="+$formData.RQLX+"&ycmc="+$formData.YCMC+"&ckqy="+$formData.CKQY);
                initCharts(jsonData);
            }
        }
    });
    $(function() {
        var configInfo = CFG_initConfigInfo({
            /** 页面名称 */
            'page' : 'hqfxzzyccsl.jsp',//入库量趋势分析页面
            /** 页面中的最大元素 */
            ...
            'bodyOnLoad' : function(configInfo) {
                ...
                var ycmc = $("#ycmc${idSuffix}");
                var ckqy = $("#ckqy${idSuffix}");
                ...
                rqlx.combobox({
                    data:[{value:1,text:'月',selected:true},{value:2,text:'年'}],
                ...
                var ycmcdata = $.loadJson($.contextPath + "/hqfxzzyccsl!searchycmc.json");
                ycmc.combobox({
                    data:ycmcdata
                });

                var ckqydata = $.loadJson($.contextPath + "/hqfxzzyccsl!searchqymc.json");
                ckqy.combobox({
                    data:ckqydata
                });
            }
