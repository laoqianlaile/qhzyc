...
window[CFG_actionName(subffix)] = function (ui) {
	...
	return jQuery.contextPath + "/sdzycnjjxx";
};
...
function _override_form (ui) {
	...
	ui._init = function() {
		...
		//新增
		if (isEmpty(ui.options.dataId)) {
			var lxData = $.loadJson($.contextPath + "/sdzycnjjxx!getLx.json");
		...
		if (!isEmpty(ui.options.dataId)) {
			...
			ui.getItemJQ("LX").combobox("reload", lxData);
			var lxData = $.loadJson($.contextPath + "/sdzycnjjxx!getLxById.json?id=" + ui.options.dataId);
