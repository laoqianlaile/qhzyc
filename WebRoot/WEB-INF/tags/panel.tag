...
.add("onExpand", onExpand).toString();
 %><div id="<%=id %>"  class="<%=cls==null?"":cls%>"  data-options="<%=dataOption %>"><jsp:doBody /></div>
<script <%= "id=" + id + "_s" %>>
Coral.cc("panel", "<%= id%>");
</script>