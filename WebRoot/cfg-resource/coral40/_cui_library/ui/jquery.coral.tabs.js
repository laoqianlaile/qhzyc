...
$.component( "coral.tabs", {
	...
	add: function(option) {
		...
		closespan=closeable===true?"<span class='icon icon-close2'></span>":"",
	...
	addnewbtn: function () {
		var that = this;
		var newbtn = $("<li class='coral-tabs-newbtn coral-corner-top'><a class='coral-tabs-anchor'><span class='icon icon-plus'></span></a></li>");
	...
	_setupEvents: function( event ) {
		...
		this._off( this.anchors.add( this.tabs ).add( this.panels ).add(this.tabs.children("span.icon-close2")) );
		...
		this._on( this.tabs.children("span.icon-close2"), { click: "_tabClose" } );
	...
	_setupHeightStyle: function( heightStyle ) {
		...
		if ( heightStyle === "fill" ) {
			...
			this.panels.each(function() {
				...
				/*if(isVertival){
					$( this ).width( Math.max( 0, maxWidth -
