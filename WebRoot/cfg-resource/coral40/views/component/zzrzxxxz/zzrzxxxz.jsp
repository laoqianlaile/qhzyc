            ...
            <div class="fill">
                ...
                <div id="hiddenDiv${idSuffix}" style="display: none;">
                    <div id="formDiv${idSuffix}">
                        ...
                        <div class='homeSpan' style="margin-top: -23px;"><div><div style='margin-left:20px;width: 150px;' id="nva${idSuffix}"> -认证信息-新增 </div></div></div>
                        <div class="toolbarsnav clearfix">
                        </div>
                        ...
                        <form id="enterForm${idSuffix}"
                            ...
                            <div class="fillwidth colspan3 clearfix">
                                <div class="app-inputdiv4">
                                    ...
                                    <input id="CPMC_${idSuffix}" name="CPMC" data-options="required:true,maxlength:50" class="coralui-textbox"/>
                                </div>
                                <div class="app-inputdiv4">
                                    ...
                                    <input id="RZMC_${idSuffix}" name="RZMC" data-options="required:true,maxlength:50" class="coralui-textbox"/>
                                </div>
                                <div class="app-inputdiv4">
                                    <label class="app-input-label" style="width:26%;">认证机构:</label>
                                        <%--<ces:datepicker id="jfsj${idSuffix}" required="true" name="jfsj" value="2015-10-12"></ces:datepicker>--%>
                                    <input id="RZJG_${idSuffix}" name="RZJG" data-options="required:true,maxlength:50" class="coralui-textbox"/>
                                </div>
                                <div class="app-inputdiv4">
                                ...
                                <div class="app-inputdiv4">
                                    <label class="app-input-label" style="width:26%;">证书编号:</label>
                                        <%--<ces:datepicker id="jfsj${idSuffix}" required="true" name="jfsj" value="2015-10-12"></ces:datepicker>--%>
                                    <input id="ZSBH_${idSuffix}" name="ZSBH" class="coralui-textbox" data-options="maxlength:50"/>
                                </div>
                                <div class="app-inputdiv4">
    ...
    $.extend($.ns("namespaceId${idSuffix}"), {
        ...
        formToolbarClick: function (event, button) {
            if (button.id == "save") {
                ...
                if(yxq<rzrq){
                    CFG_message("有效期不能小于申请日期！", "error");return
                }
        ...
        loadImage:function(tplj){
            ...
            image.onload = function (e) {
                ...
                $(div).append(this);
                $(div).append('<span style="display: none;position: absolute; margin-top: 6px; margin-left: 6px; width: 20px; height: 20px;"><img onclick = "deleteImage(\'' + this.src + '\')" style = "height:20px" src = "<%=resourceFolder%>/css/images/trace-image/trash_bin.png"></span>');
               ...
               div.style.float = "left";
                ...
                if($("#preview${idSuffix}").css("width") != "0px"){
                    $("#chooseImage${idSuffix}").css("margin-top","10px");
                }
            };
        }
    });
